...
WebDroneScraper.prototype = {

    scrapLink : function (link, endCallback, loadcharge) {
        var self = this;
        if(!link)
            return;
    ...
    scrap : function (list, eachCallback, endCallback) {
        var self = this;
        if(!list) {
    ...
    sitemap : function (mapfile, host, port, eachCallback, endCallback) { //"../sitemap.json"
        var self = this;
        if(!mapfile) {
            if(endCallback) endCallback();
            return;
